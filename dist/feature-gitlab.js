...
}`,p=await this.graphql(e,t,r?.baseUrl,d,{fullPath:`${s}/${l}`,iid:String(u)});if(((a=(n=p?.data)==null?void 0:n.project)==null?void 0:a.issue)!=null){const E=p.data.project.issue;return{provider:e,type:m.IssueOrPullRequestType.Issue,id:E.iid,date:new Date(E.createdAt),title:E.title,closed:E.state==="closed",closedDate:E.closedAt==null?void 0:new Date(E.closedAt),url:E.webUrl}}if(((i=(o=p?.data)==null?void 0:o.project)==null?void 0:i.mergeRequest)!=null){const E=p.data.project.mergeRequest;return{provider:e,type:m.IssueOrPullRequestType.PullRequest,id:E.iid,date:new Date(E.createdAt),title:E.title,closed:E.state==="closed",closedDate:E.state==="closed"?new Date(E.updatedAt):void 0,url:E.webUrl}}return}catch(d){if(d instanceof c.Ww)return;throw this.handleException(d,e,g)}}async getPullRequestForBranch(e,t,s,l,u,r){var n,a,o,i,g,d,p,E,W,F,Y,K,J,z,Z,H,X,V,Q,k,ee,te;const ne=h.Y.getCorrelationContext();try{const L=`
			nodes {
				iid
				author {
					name
...
}`,S=await this.graphql(e,t,r?.baseUrl,le,{fullPath:`${s}/${l}`,branches:[u],state:r?.include});let D;if(r?.include==null)D=(p=(d=(g=(i=S?.data)==null?void 0:i.project)==null?void 0:g.mergeRequests)==null?void 0:d.nodes)==null?void 0:p[0];else for(const x of r.include){let $;x===P.GitLabMergeRequestState.OPEN?$=(Y=(F=(W=(E=S?.data)==null?void 0:E.project)==null?void 0:W.opened)==null?void 0:F.nodes)==null?void 0:Y[0]:x===P.GitLabMergeRequestState.MERGED?$=(Z=(z=(J=(K=S?.data)==null?void 0:K.project)==null?void 0:J.merged)==null?void 0:z.nodes)==null?void 0:Z[0]:x===P.GitLabMergeRequestState.CLOSED&&($=(Q=(V=(X=(H=S?.data)==null?void 0:H.project)==null?void 0:X.closed)==null?void 0:V.nodes)==null?void 0:Q[0]),$!=null&&(D==null||new Date($.updatedAt)>new Date(D.updatedAt))&&(D=$)}return D==null?void 0:new m.PullRequest(e,{name:((k=D.author)==null?void 0:k.name)??"Unknown",avatarUrl:((ee=D.author)==null?void 0:ee.avatarUrl)??"",url:((te=D.author)==null?void 0:te.webUrl)??""},String(D.iid),D.title,D.webUrl,P.GitLabMergeRequest.fromState(D.state),new Date(D.updatedAt),D.state!==P.GitLabMergeRequestState.CLOSED?void 0:new Date(D.updatedAt),D.mergedAt==null?void 0:new Date(D.mergedAt))}catch(L){if(L instanceof c.Ww)return;throw this.handleException(L,e,ne)}}async getPullRequestForCommit(e,t,s,l,u,r){const n=h.Y.getCorrelationContext(),a=await this.getProjectId(e,t,s,l,r?.baseUrl);if(!!a)try{const o=await this.request(e,t,r?.baseUrl,`v4/projects/${a}/repository/commits/${u}/merge_requests`,{method:"GET"});return o==null||o.length===0?void 0:(o.length>1&&o.sort((i,g)=>(i.state===P.GitLabMergeRequestState.OPEN?-1:1)-(g.state===P.GitLabMergeRequestState.OPEN?-1:1)||new Date(g.updated_at).getTime()-new Date(i.updated_at).getTime()),P.GitLabMergeRequestREST.from(o[0],e))}catch(o){if(o instanceof c.Ww)return;throw this.handleException(o,e,n)}}async findUser(e,t,s,l){var u,r;const n=h.Y.getCorrelationContext();try{const a=`query findUser(
$search: String!
) {
	users(search: $search) {
		nodes {
